<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/www/web/zhu1_51zuopin_com/public_html/../application/admin/view/attributes/edit.html";i:1528958395;s:81:"/www/web/zhu1_51zuopin_com/public_html/../application/admin/view/common/base.html";i:1528958400;}*/ ?>
...
function translateadd(id){
	...
	$.ajax({
		url:'<?php echo url('Attributes/edit'); ?>',
		type:'post',
		dataType:'json',
		data: data,
