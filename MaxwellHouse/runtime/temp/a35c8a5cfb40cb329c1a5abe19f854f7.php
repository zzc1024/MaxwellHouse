<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/www/web/zhu1_51zuopin_com/public_html/../application/admin/view/attributes/add.html";i:1528958395;s:81:"/www/web/zhu1_51zuopin_com/public_html/../application/admin/view/common/base.html";i:1528958400;}*/ ?>
	...
	<form class="form form-horizontal" id="form-translate-add">
		...
		<div class="row cl">
			<div class="col-9 col-offset-3">
				<input onClick="translateadd()" class="btn btn-primary radius" type="button" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
			</div>
		</div>
	</form>
</div>
...
function translateadd(){
	...
	$.ajax({
		url:'<?php echo url('Attributes/add'); ?>',
		type:'post',
		dataType:'json',
		data: data,
