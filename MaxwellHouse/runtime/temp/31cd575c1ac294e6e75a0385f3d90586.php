<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/www/web/zhu1_51zuopin_com/public_html/../application/index/view/login/register.html";i:1528965596;s:81:"/www/web/zhu1_51zuopin_com/public_html/../application/index/view/common/base.html";i:1529032646;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<script type="text/javascript">
			...
			function register(){
				if($('input[type="checkbox"]').is(':checked')){
					...
					$.ajax({
						url:'<?php echo url('Login/register_add'); ?>',
						type:'post',
						data:data,
						dataType:'json',
