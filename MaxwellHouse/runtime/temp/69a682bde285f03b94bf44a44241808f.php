<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\phpStudy\WWW\items\public/../application/index\view\users\address.html";i:1528623554;s:71:"D:\phpStudy\WWW\items\public/../application/index\view\common\base.html";i:1528888923;s:75:"D:\phpStudy\WWW\items\public/../application/index\view\Users\left_base.html";i:1528893048;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<div class="content">
			<div>
				...
				<div class="cont_right_top address">
					...
					<h4>地址管理</h4>
					<a href="<?php echo url('Users/addressadd'); ?>">新增地址</a>
					<table border="0" cellspacing="0" cellpadding="0">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="button" value="删除" onclick="a_delete(<?php echo $v['id']; ?>)">
								</td>
							</tr>
							<?php endforeach; endif; else: echo "" ;endif; ?>
						</tbody>
		...
		<script type="text/javascript">
			function a_delete(id){
				...
				layer.confirm('确认要删除吗？',function(){
					$.ajax({
						url:'<?php echo url('Users/a_delete'); ?>',
						type:'post',
						data:id,
						dataType:'json',
