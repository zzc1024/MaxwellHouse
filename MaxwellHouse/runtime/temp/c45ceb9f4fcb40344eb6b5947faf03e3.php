<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/www/web/zhu1_51zuopin_com/public_html/../application/admin/view/admins/edit.html";i:1528958395;s:81:"/www/web/zhu1_51zuopin_com/public_html/../application/admin/view/common/base.html";i:1528958400;}*/ ?>
...
<article class="page-container">
  ...
  <div class="row cl">
    ...
    <div class="formControls col-xs-8 col-sm-9">
      ...
      <input type="text" class="input-text" value="<?php echo $result['admin_name']; ?>" placeholder="" id="adminName" name="admin_name">
    </div>
  </div>
  <div class="row cl">
    <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>账号：</label>
    <div class="formControls col-xs-8 col-sm-9">
      <input type="text" class="input-text" value="<?php echo $result['admin_account']; ?>" placeholder="" id="adminName" name="admin_account" readonly="readonly">
    </div>
  </div>
  <div class="row cl">
  ...
  <div class="row cl">
    ...
    <div class="formControls col-xs-8 col-sm-9">
      <input type="text" class="input-text" value="<?php echo $result['admin_phone']; ?>" placeholder="" id="phone" name="admin_phone">
    </div>
  </div>
  <div class="row cl">
    <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>邮箱：</label>
    <div class="formControls col-xs-8 col-sm-9">
      <input type="text" class="input-text" name="admin_email" id="email" value="<?php echo $result['admin_email']; ?>">
    </div>
  </div>
  <div class="row cl">
    ...
    <div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
      ...
      <?php if(is_array($res) || $res instanceof \think\Collection || $res instanceof \think\Paginator): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($result2['role_id'] == $v['role_id']): ?>
        <option value="<?php echo $v['role_id']; ?>" checked="checked"><?php echo $v['role_name']; ?></option>
      <?php else: ?>
