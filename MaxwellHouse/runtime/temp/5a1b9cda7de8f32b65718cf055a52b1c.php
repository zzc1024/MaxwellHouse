<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/www/web/zhu1_51zuopin_com/public_html/../application/admin/view/banners/add.html";i:1528958396;s:81:"/www/web/zhu1_51zuopin_com/public_html/../application/admin/view/common/base.html";i:1528958400;}*/ ?>
...
function banneradd(){
	...
	$.ajax({
		url:'<?php echo url('Banners/banner_add'); ?>',
		type:'post',
		dataType:'json',
		data: formData,
		contentType: false, 
