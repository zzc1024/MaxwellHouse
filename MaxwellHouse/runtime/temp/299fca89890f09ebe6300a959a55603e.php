<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\php\PHPTutorial\WWW\items\public/../application/admin\view\login\index.html";i:1528287913;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
    ...
    <form class="form form-horizontal">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="<?php echo captcha_src(); ?>" onclick="this.src='<?php echo captcha_src(); ?>'"> <a id="kanbuq" href="javascript:;">看不清，换一张</a> </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
        </div>
