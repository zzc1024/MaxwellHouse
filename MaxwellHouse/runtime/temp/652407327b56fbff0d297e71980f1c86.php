<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/www/web/zhu1_51zuopin_com/public_html/../application/admin/view/banners/edit.html";i:1528958397;s:81:"/www/web/zhu1_51zuopin_com/public_html/../application/admin/view/common/base.html";i:1528958400;}*/ ?>
...
function banneradd(){
	...
	$.ajax({
		url:'<?php echo url('Banners/banner_edit'); ?>',
		type:'post',
		dataType:'json',
		data: formData,
		contentType: false, 
