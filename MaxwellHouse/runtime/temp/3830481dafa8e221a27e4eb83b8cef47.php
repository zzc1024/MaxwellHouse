<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/www/web/zhu1_51zuopin_com/public_html/../application/admin/view/waters/add.html";i:1528958410;s:81:"/www/web/zhu1_51zuopin_com/public_html/../application/admin/view/common/base.html";i:1528958400;}*/ ?>
...
function banneradd(){
	...
	$.ajax({
		url:'<?php echo url('Waters/water_add'); ?>',
		type:'post',
		dataType:'json',
		data: formData,
		contentType: false, 
